...
- **Request IDs**: Unique request IDs for audit trail
- **CORS**: Configured for controlled cross-origin requests
- **Secrets**: Sensitive data should never be logged
- **Database**: Use connection pooling and prepared statements
- **Environment Variables**: Never commit `.env` files to version control

## 📚 Additional Documentation

- [Backend README](backend/README.md) - Detailed backend architecture and API documentation
- [Frontend README](frontend/README.md) - Frontend features and configuration
- [Frontend Setup Guide](frontend/SETUP.md) - Step-by-step frontend setup instructions

## 🤝 Contributing

1. Follow the existing code structure and naming conventions
2. Write tests for new features
3. Ensure all tests pass: `go test ./...` (backend) and `npm test` (frontend)
...
# Test connection
docker-compose exec db psql -U compliance_user -d compliance_db -c "SELECT version();"
```
